import styles from "./MyProjectDataTable.module.scss";
import {
  DataGrid,
  GridColDef,
...
type MyProjectDataTableProps = {
  projects: Project[];
};

const MyProjectDataTable = ({ projects }: MyProjectDataTableProps) => {
  ...
  return (
    <div className={styles.myProjectDataTable}>
      <DataGrid
...
export default MyProjectDataTable;
